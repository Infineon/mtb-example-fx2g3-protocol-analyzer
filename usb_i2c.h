 ...
 * \brief  Function to read data from i2c slave
 * \param base  scb base
 * \param dev_addr i2c slave register address
 * \param size 
 * \param send_stop stop to send after read (in bytes)
 * \retval 0 for read success, error code for unsuccess.
 */
 ...
 * \param base  scb base
 * \param dev_addr i2c slave register address
 * \param size to data receive buffer
 * \param send_stop stop to send after read (in bytes)
 * \retval 0 for read success, error code for unsuccess.
 */
 ...
 * \brief  Function to set or clear a bit
 * \param base  scb base
 * \param pinNum I2c PIN
 * \param value 
 * \retval none.
 */
